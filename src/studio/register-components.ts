...
export const components: RegisterComponentOptionsInput<(props?: any) => React.ReactNode>[] = [{
  ...
  thumbnailUrl: "https://composo-image.contentstack.com/c5f06a68-976b-40f6-8d98-98516d287628",
  props: {
    "categories": {
      type: "array",
  ...
  component: EventsFaq,
  thumbnailUrl: "https://composo-image.contentstack.com/491bc2e1-0a38-4a14-8f93-759b7a19cdad",
  props: {
    "breadcrumbText1": {
      type: "string",
      ...
      defaultValue: [
        {
          ...
          reply: "Yes, we offer customized packages for weddings, anniversaries, birthdays, and other special occasions. Our event planning team will work with you to create a memorable experience tailored to your needs.",
          uid: "a6b84d93-91b4-4545-bfdc-bf69755b2053"
        },
        {
          question: "Do you offer any amenities such as complimentary breakfast or WiFi?",
          answer: "Yes, we provide complimentary high-speed WiFi throughout the property and a delicious breakfast buffet is included with most room bookings. Additional amenities vary by room type.",
          uid: "07e41ce1-71dc-494d-9220-d4fd89b01793"
        },
        {
          question: "Can I request a specific room location or view?",
          answer: "Absolutely! We'll do our best to accommodate your preferences for room location and view. Please mention your requirements during booking or contact our reservations team in advance.",
          uid: "b02e336a-5b49-4db6-9d91-9d48a7186f25"
        },
        {
          question: "Can I book a private event or celebration at the hotel?",
          answer: "Yes, we have dedicated event spaces available for private celebrations, corporate events, and gatherings. Our events team can help you plan everything from intimate dinners to large receptions.",
          uid: "e7ca6b15-abcf-41e0-ad99-195a77fedd9e"
        },
        {
          question: "Are there any seasonal events or festivals hosted by the hotel?",
          answer: "We host various seasonal events and cultural celebrations throughout the year, including holiday festivities, local festivals, and special themed nights. Check our events calendar for upcoming activities during your stay.",
